namespace GameBench
{
    ...
    public class SceneLoader : MonoBehaviour
    {
        ...
        private void Start()
        {
            StartCoroutine(AsynLoadScene("MainMenu"));

        }

        public void LoadingInterface(string sceneToLoad)
        {
            AsynLoadScene(sceneToLoad);
        }

        bool animDone = false;
        private IEnumerator AsynLoadScene(string sceneToLoad)
        {
            ...
            asyncLoad = null;
            loader[loaderClip].normalizedTime = 3.0f;
            yield return new WaitForEndOfFrame();
            if (animDone)

...
public class make2sectL1 : MonoBehaviour
{
    ...
    public void gen(float currRight, int sliceNum, float sliceLength)
    {
        ...
        Debug.Log("Level 3 Section Type 2 procedural generation done: " + count);
    }
    ...
    {
        powerUpChoice = Random.Range(1, 4);//powerUpChoice can be 1, 2 or 3
